...
$order_total = $customer_orders->total;
							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									...
									foreach ( $actions as $key => $action ) { 
										...
										echo '<a href="' . esc_url( $action['url'] ) . '" class="wcmtx_custom_action woocommerce-button  button "><span class="wcmtx_action_name">' . esc_html( $action['name'] ) . '</span><span class="wcmtx_action_html">'.$icon_html.'</a></span>';
									}
								}
								?>
							<?php endif; ?>
