...
$show_lost_pwd_text = 'yes';

if (isset($plugin_options['hide_lost_password_text']) && ($plugin_options['hide_lost_password_text'] == "yes")) { 

	$show_lost_pwd_text = 'no';
