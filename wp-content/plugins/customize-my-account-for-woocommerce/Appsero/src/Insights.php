...
class Insights
{
    ...
    public function __construct($client, $name = null, $file = null)
    {
        ...
        if (is_object($client) && is_a($client, 'wcmamtx_Appsero\Client')) {
            $this->client = $client;
        }
    }
    ...
    /**
     * Send tracking data to wcmamtx_Appsero server
     *
     * @param bool $override
     *
     * @return void
    ...
    private function is_local_server()
    {
        ...
        return apply_filters('wcmamtx_Appsero_is_local', $is_local);
    }
    ...
    public function uninstall_reason_submission()
    {
        ...
        if (!wp_verify_nonce(sanitize_key(wp_unslash($_POST['nonce'])), 'wcmamtx_Appsero-security-nonce')) {
    ...
    public function deactivate_scripts()
    {
        ...
        $custom_reasons = apply_filters('wcmamtx_Appsero_custom_deactivation_reasons', [], $this->client);
?>
        ...
        <div class="wd-dr-modal" id="<?php echo $this->client->slug; ?>-wd-dr-modal">
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-footer">
                    ...
                    <a target="_blank" style="background-color:green;color:white;float:left;" href="https://www.sysbasics.com/customize-my-account-free-plugin-support/" class="wd-dr-button-secondary"><?php $this->client->_etrans('Contact Support (Paid)'); ?></a>
                ...
                $(function() {
                    ...
                    modal.on('click', 'button.wd-dr-submit-modal', function(e) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                nonce: '<?php echo wp_create_nonce('wcmamtx_Appsero-security-nonce'); ?>',
    ...
    {
        // Make sure this is wcmamtx_Appsero theme
    ...
    /**
     * Send request to wcmamtx_Appsero if user skip to send tracking data
     */
