...
namespace wcmamtx_Appsero;

/**
 * wcmamtx_Appsero License Checker
 *
...
class License {
    ...
    public function __construct( Client $client ) {
        ...
        $this->option_key = 'wcmamtx_Appsero_' . md5( $this->client->slug ) . '_manage_license';

        $this->schedule_hook = $this->client->slug . '_license_check_event';

        // Creating WP Ajax Endpoint to refresh license remotely
        add_action( 'wp_ajax_wcmamtx_Appsero_refresh_license_' . $this->client->hash, [ $this, 'refresh_license_api' ] );
    ...
    public function menu_output() {
        ...
        <div class="wrap wcmamtx_Appsero-license-settings-wrapper">
            <h1>License Settings</h1>

            <?php
                $this->show_license_page_notices();
                do_action( 'before_wcmamtx_Appsero_license_section' );
            ?>

            <div class="wcmamtx_Appsero-license-settings wcmamtx_Appsero-license-section">
                <?php $this->show_license_page_card_header( $license ); ?>

                <div class="wcmamtx_Appsero-license-details">
                    <p>
            ...
            </div> <!-- /.wcmamtx_Appsero-license-settings -->

            <?php do_action( 'after_wcmamtx_Appsero_license_section' ); ?>
        </div>
        <?php
    }
    ...
    private function licenses_style() {
        ?>
        <style type="text/css">
            .wcmamtx_Appsero-license-section {
                width: 100%;
                max-width: 1100px;
                min-height: 1px;
                box-sizing: border-box;
            }
            .wcmamtx_Appsero-license-settings {
            ...
            .wcmamtx_Appsero-license-title svg {
                width: 30px;
                height: 30px;
                fill: #0082BF;
            }
            .wcmamtx_Appsero-license-title span {
                font-size: 17px;
                color: #444444;
                margin-left: 10px;
            }
            .wcmamtx_Appsero-license-details {
                padding: 20px;
            }
            .wcmamtx_Appsero-license-details p {
                font-size: 15px;
                margin: 0 0 20px 0;
            }
            .license-input-key {
            ...
            .wcmamtx_Appsero-license-right-form {
                margin-left: auto;
            }
            .wcmamtx_Appsero-license-refresh-button {
            ...
            .wcmamtx_Appsero-license-refresh-button .dashicons {
                color: #fff;
                margin-left: 0;
            }
        </style>
    ...
    private function show_license_page_notices() {
        if ( ! empty( $this->error ) ) {
            ?>
            <div class="notice notice-error is-dismissible wcmamtx_Appsero-license-section">
        ...
        if ( ! empty( $this->success ) ) {
            ?>
            <div class="notice notice-success is-dismissible wcmamtx_Appsero-license-section">
    ...
    private function show_license_page_card_header( $license ) {
        ?>
        <div class="wcmamtx_Appsero-license-title">
            ...
            <form method="post" class="wcmamtx_Appsero-license-right-form" novalidate="novalidate" spellcheck="false">
                <input type="hidden" name="_action" value="refresh">
                <input type="hidden" name="_nonce" value="<?php echo wp_create_nonce( $this->client->name ); ?>">
                <button type="submit" name="submit" class="wcmamtx_Appsero-license-refresh-button">
