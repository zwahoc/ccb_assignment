...
class JsonMapperTest_DependencyInjector extends \WPForms\Vendor\apimatic\jsonmapper\JsonMapper
{
    /**
     ...
     */
    public function createInstance($class, &$jobject = null, $forMultipleTypes = \false)
    {
