 ...
 */
class JsonMapperTest extends \WPForms\Vendor\PHPUnit\Framework\TestCase
{
    /**
     * Test for "@var string"
     */
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"str":"stringvalue"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->mapClass(\json_decode('{"str":"stringvalue"}'), 'JsonMapperTest_Simple');
        $this->assertTrue(\is_string($obj->str));
        $this->assertEquals('stringvalue', $obj->str);
    }
    /**
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"fl":"1.2"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"db":"1.2"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pbool":"1"}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_bool($obj->pbool));
        $this->assertEquals(\true, $obj->pbool);
    }
    /**
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pboolean":"0"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pint":"123"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pinteger":"12345"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"mixed":12345}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pnullable":0}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pnullable":null}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pnullable":"12345"}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_int($obj->pnullable));
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"notype":{"k":"v"}}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"under_score":"f"}'), new JsonMapperTest_Simple());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"under_score_setter":"blubb"}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_string($obj->internalData['under_score_setter']));
        $this->assertEquals('blubb', $obj->internalData['under_score_setter']);
    }
    /**
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"simple":{"str":"stringvalue"}}'), new JsonMapperTest_Simple());
    ...
    public function testMapTypedArray()
    {
        ...
        $obj = $jm->map(\json_decode('{"typedArray":[{"str":"stringvalue"},{"fl":"1.2"}]}'), new JsonMapperTest_Array());
    ...
    public function testMapNullableTypedArray()
    {
        $jm = new JsonMapper();
        $jm->arChildClasses['JsonMapperTest_Simple'] = array();
        $obj = $jm->map(\json_decode('{"nullableTypedArray":[{"str":"stringvalue"}, null]}'), new JsonMapperTest_Array());
    ...
    public function testMapTypedMap()
    {
        $jm = new JsonMapper();
        $jm->arChildClasses['JsonMapperTest_Simple'] = array();
        $obj = $jm->map(\json_decode('{"typedMap":{"key0":{"str":"stringvalue"},"key1":{"fl":"1.2"}}}'), new JsonMapperTest_Array());
    ...
    public function testMapTypedArrayOfMap()
    {
        $jm = new JsonMapper();
        $jm->arChildClasses['JsonMapperTest_Simple'] = array();
        $obj = $jm->map(\json_decode('{"typedArrayOfMap":[{"class1":{"str":"stringvalue"},"class2":{"fl":"1.2"}},{"class3":{"pbool":true}}]}'), new JsonMapperTest_Array());
        ...
        $this->assertEquals(\true, $obj->typedArrayOfMap[1]['class3']->pbool);
    }
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"typedSimpleArray":["2014-01-02",null,"2014-05-07"]}'), new JsonMapperTest_Array());
        ...
        $this->assertEquals('2014-01-02', $obj->typedSimpleArray[0]->format('Y-m-d'));
        $this->assertEquals('2014-05-07', $obj->typedSimpleArray[2]->format('Y-m-d'));
    }
    ...
    public function testOpCacheSaveCommentsDiscarded()
    {
        ...
        if (\in_array(\strtolower(\ini_get("opcache.save_comments")), $enable, \true)) {
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"flArray":[1.23,3.14,2.048]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"strArray":["str",false,2.048]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"nullableStrArray":["str",null,"123"]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"strMap":{"key0":"str","key1":false,"key2":2.048}}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"strMapOfArray":{"key0":["str","other"],"key1":[false,3],"key2":[2.048,"asad"]}}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"strArrayOfMap":[{"key0":"str","key1":"other"},{"key0":false,"key1":3},{"key0":2.048,"key1":"asad"}]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pArrayObject":[{"str":"stringvalue"},{"fl":"1.2"}]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pTypedArrayObject":[{"str":"stringvalue"},{"fl":"1.2"}]}'), new JsonMapperTest_Array());
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pSimpleArrayObject":{"eins":"1","zwei":"1.2"}}'), new JsonMapperTest_Array());
    ...
    public function testMapEmpty()
    {
        ...
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"empty":{"a":"b"}}'), new JsonMapperTest_Simple());
    }
    /**
    ...
    public function testMapTypedArrayObjectDoesNotExist()
    {
        ...
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"pTypedArrayObjectNoClass":[{"str":"stringvalue"}]}'), new JsonMapperTest_Broken());
        $this->assertInstanceOf('ArrayObject', $obj->pTypedArrayObjectNoClass);
        $this->assertEquals(1, \count($obj->pTypedArrayObjectNoClass));
        $this->assertInstanceOf('ThisClassDoesNotExist', $obj->pTypedArrayObjectNoClass[0]);
    }
    public function mapTypedArrayObjectDoesNotExistAutoloader($class)
    {
        $this->assertFalse(\strpos($class, '['), 'class name contains a "[": ' . $class);
        $code = '';
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"simpleSetterOnlyTypeHint":{"str":"stringvalue"}}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_object($obj->internalData['typehint']));
        $this->assertInstanceOf('JsonMapperTest_Simple', $obj->internalData['typehint']);
        $this->assertEquals('stringvalue', $obj->internalData['typehint']->str);
    }
    /**
     * There is no property, but a setter method.
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"simpleSetterOnlyDocblock":{"str":"stringvalue"}}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_object($obj->internalData['docblock']));
        $this->assertInstanceOf('JsonMapperTest_Simple', $obj->internalData['docblock']);
        $this->assertEquals('stringvalue', $obj->internalData['docblock']->str);
    }
    /**
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"simpleSetterOnlyNoType":{"str":"stringvalue"}}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_object($obj->internalData['notype']));
        $this->assertInstanceOf('stdClass', $obj->internalData['notype']);
        $this->assertEquals('stringvalue', $obj->internalData['notype']->str);
    }
    /**
    ...
    public function testMapProtectedWithoutSetterMethod()
    {
        ...
        $jm->setLogger($logger);
        $obj = $jm->map(\json_decode('{"protectedStrNoSetter":"stringvalue"}'), new JsonMapperTest_Simple());
        $this->assertNull($obj->getProtectedStrNoSetter());
        $this->assertEquals(array(array('info', 'Property {property} has no public setter method in {class}', array('class' => 'JsonMapperTest_Simple', 'property' => 'protectedStrNoSetter'))), $logger->log);
    }
    public function testMapDateTime()
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"datetime":"2014-04-01T00:00:00+02:00"}'), new JsonMapperTest_Simple());
        $this->assertInstanceOf('DateTime', $obj->datetime);
        $this->assertEquals('2014-04-01T00:00:00+02:00', $obj->datetime->format('c'));
    }
    public function testMapDateTimeNull()
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"datetime":null}'), new JsonMapperTest_Simple());
    ...
    public function testMissingDataException()
    {
        ...
        $jm = new JsonMapper();
        $jm->bExceptionOnMissingData = \true;
        $obj = $jm->map(\json_decode('{}'), new JsonMapperTest_Broken());
    }
    /**
    ...
    public function testMissingDataNoException()
    {
        $jm = new JsonMapper();
        $jm->bExceptionOnMissingData = \true;
        $obj = $jm->map(\json_decode('{"pMissingData":1}'), new JsonMapperTest_Broken());
        $this->assertTrue(\true);
    }
    public function testUndefinedPropertyException()
    {
        ...
        $jm = new JsonMapper();
        $jm->bExceptionOnUndefinedProperty = \true;
        $obj = $jm->map(\json_decode('{"undefinedProperty":123}'), new JsonMapperTest_Broken());
    }
    ...
    {
        $jm = new JsonMapper();
        $obj = $jm->map(\json_decode('{"setterPreferredOverProperty":"foo"}'), new JsonMapperTest_Simple());
        $this->assertTrue(\is_string($obj->setterPreferredOverProperty));
        $this->assertEquals('set via setter: foo', $obj->setterPreferredOverProperty);
    }
    public function testSettingValueObjects()
    {
        $valueObject = new JsonMapperTest_ValueObject('test');
        $jm = new JsonMapper();
        $obj = $jm->map((object) array('value_object' => $valueObject), new JsonMapperTest_Simple());
        $this->assertSame($valueObject, $obj->getValueObject());
    }
    public function testCaseInsensitivePropertyMatching()
    {
        $jm = new JsonMapper();
        $obj = $jm->map((object) array('PINT' => 2), new JsonMapperTest_Simple());
        $this->assertSame(2, $obj->pint);
    }
    public function testDependencyInjection()
    {
        $jm = new JsonMapperTest_DependencyInjector();
        $obj = $jm->map((object) array('str' => 'first level', 'simple' => (object) array('str' => 'second level')), $jm->createInstance('JsonMapperTest_Simple'));
    ...
    public function testDiscriminatorWithBaseTypeWithMissingDiscriminatorType()
    {
        ...
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'base'), 'JsonMapperTest_SimpleBaseWithMissingDiscrimType');
    ...
    public function testDiscriminatorWithBaseType()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'base'), 'JsonMapperTest_SimpleBase');
    ...
    public function testDiscriminatorWithIncorrectDiscriminatorValue()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'incorrect!'), 'JsonMapperTest_SimpleBase');
        $this->assertInstanceOf('JsonMapperTest_SimpleBase', $obj);
        $this->assertEquals('abc', $obj->afield);
        $this->assertEquals(12, $obj->bfield);
    ...
    public function testDiscriminatorWithInvalidClassName()
    {
        ...
        $jm = new JsonMapper();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'incorrect!'), 'InvalidClassThatDoesNotExist');
    }
    public function testDiscriminatorWithDerivedType()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived1', 'derived1Field' => 'derived1 field'), 'JsonMapperTest_SimpleBase');
    ...
    public function testDiscriminatorWithTwoLevelDerivedType()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'derived1Field' => 'derived1 field', 'derived2Field' => 'derived2 Field'), 'JsonMapperTest_SimpleBase');
    ...
    public function testDiscriminatorWithArrayOfObjects()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClassArray(array((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'base'), (object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived1', 'derived1Field' => 'derived1 field'), (object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'derived1Field' => 'derived1 field', 'derived2Field' => 'derived2 Field')), 'JsonMapperTest_SimpleBase');
    ...
    public function testDiscriminatorWithEmbeddedObject()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'embedded' => (object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'derived1Field' => 'derived1 field', 'derived2Field' => 'derived2 Field')), 'JsonMapperTest_SimpleBase');
        $this->assertInstanceOf('JsonMapperTest_SimpleBase', $obj);
    ...
    public function testDiscriminatorWithEmbeddedObjectArray()
    {
        ...
        $jm->arChildClasses['JsonMapperTest_DerivedClass'] = array('JsonMapperTest_DerivedClass2');
        $jm->arChildClasses['JsonMapperTest_DerivedClass2'] = array();
        $obj = $jm->mapClass((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'embeddedArray' => array((object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived1', 'derived1Field' => 'derived1 field'), (object) array('afield' => 'abc', 'bfield' => 12, 'type' => 'derived2', 'derived1Field' => 'derived1 field', 'derived2Field' => 'derived2 Field'))), 'JsonMapperTest_SimpleBase');
        $this->assertInstanceOf('JsonMapperTest_SimpleBase', $obj);
    ...
    {
        $jm = new JsonMapper();
        $fm = $jm->map(\json_decode('{"simple":"hello world", "value":123, "bool": 0, "datetime": 1511247096, "object": "some value", "objObj":{"a":"b"}, "array": [1,2,3], "valueArr":[1,2,3], "privateValue": 4242}'), new FactoryMethod());
    ...
    public function testFactoryMethodException()
    {
        ...
        $jm = new JsonMapper();
        $fm = $jm->map(\json_decode('{"simple":"hello world"}'), new FactoryMethodWithError());
    }
    public function testMapsAnnotationOnSetter()
    {
        $jm = new JsonMapper();
        $fm = $jm->map(\json_decode('{"name":"hello","my_age":123123, "factoryValue": "factval", "public": "yes"}'), new MapsWithSetters());
    ...
    public function testAdditionalPropertiesTypedNative()
    {
        ...
        $fm = $jm->map(\json_decode('{"random11":"hello","random22":123123}'), new JsonMapperTest_Simple());
    ...
    public function testAdditionalPropertiesTypedCustom()
    {
        ...
        $fm = $jm->map(\json_decode('{"random11":"hello","random22":123123,"random33":{"under_score":"abc","random11":"hello","random33":{"fl":1.214}}}'), new JsonMapperTest_Simple());
        $this->assertEquals(1, \count($fm->additional));
    ...
    public function testAdditionalPropertiesFactory()
    {
        ...
        $fm = $jm->map(\json_decode('{"random11":"hello","random22":123123,"random23":1,"random33":true}'), new JsonMapperTest_Simple());
        ...
        $this->assertEquals(\true, $fm->additional['random23']);
    ...
    public function testAdditionalPropertiesMapsBy()
    {
        ...
        $fm = $jm->map(\json_decode('{"random11":"hello","random22":123.123,"random23":1.0,"random33":true}'), new JsonMapperTest_Simple());
        $this->assertEquals(2, \count($fm->additional));
        $this->assertEquals('hello', $fm->additional['random11']);
        $this->assertEquals(\true, $fm->additional['random33']);
    }
    ...
    {
        $jm = new JsonMapper();
        $fm = $jm->mapClass(\json_decode('{"attr1":"hello","attr2":123123}'), 'ClassWithCtor');
    ...
    public function testMapTypeWithCtorMissingArgument()
    {
        ...
        $jm = new JsonMapper();
        $fm = $jm->mapClass(\json_decode('{"attr1":"hello"}'), 'ClassWithCtor');
    }
    public function testMapTypeWithCtorComplex()
    {
        $jm = new JsonMapper();
        $fm = $jm->mapClass(\json_decode('{"anotherSetter":"something","attr1":"hello","attr2":123123,"attr3":1,"attr4":true,"attr5":["abc"],"anotherProp":"foo"}'), 'ComplexClassWithCtor');
        $this->assertEquals("hello", $fm->getAttr1());
        $this->assertEquals(123123, $fm->getAttr2());
        $this->assertEquals(2, $fm->attr3);
        $this->assertEquals(\true, $fm->foo);
    ...
    public function testPhp7BasicTypeHints()
    {
        if (\PHP_VERSION_ID >= 70000) {
            $jm = new JsonMapper();
            $fm = $jm->mapClass(\json_decode('{"name":"abcdef","age":30,"value":"givenvalue"}'), 'Php7TypedClass');
    ...
    public function testPhp7_1BasicTypeHints()
    {
        if (\PHP_VERSION_ID >= 70100) {
            $jm = new JsonMapper();
            $fm = $jm->mapClass(\json_decode('{"nullableArray":["value1","value2"]}'), 'Php7_1TypedClass');
