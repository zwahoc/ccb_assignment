...
class RequestTest extends TestCase
{
    ...
    {
        $httpClient = new HttpClient(Configuration::init()->defaultHeaders(['header1' => 'Hello', 'header2' => 'world']));
        $response = $httpClient->execute(new Request('http://mockbin.com/request'));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('Hello', $response->getBody()->headers->header1);
        $this->assertEquals('world', $response->getBody()->headers->header2);
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['header1' => 'Custom value']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient(Configuration::init()->defaultHeader('Hello', 'custom'));
        $response = $httpClient->execute(new Request('http://mockbin.com/request'));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['user-agent' => 'unirest-php']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request?name=Mark', RequestMethod::GET, ['Accept' => 'application/json'], ['nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['Accept' => 'application/json'], ['key' => 'value', 'items' => ['item1', 'item2']]));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['Accept' => 'application/json'], ['user.name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['Accept' => 'application/json'], ['user.name' => 'Mark Bond', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['Accept' => 'application/json'], ['name' => 'Mark=Hello']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, ['Accept' => 'application/json'], ['name' => 'Mark=Hello=John']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::GET, [], ['name[0]' => 'Mark', 'name[1]' => 'John']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('GET', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request?name=Mark', RequestMethod::HEAD, ['Accept' => 'application/json']));
        $this->assertEquals(200, $response->getStatusCode());
    }
    // POST
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], ['name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $body = Body::Form(['name' => 'Mark', 'nick' => 'thefosk']);
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], $body));
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $body = Body::Multipart(['name' => 'Mark', 'nick' => 'thefosk']);
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], $body));
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $body = Body::Form(['name' => 'Mark=Hello']);
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], $body));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], ['name[0]' => 'Mark', 'name[1]' => 'John']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], ['user.name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json', 'Content-Type' => 'application/json'], \json_encode(['author' => 'Sam Sullivan'])));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $body = Body::Form(['key' => 'value', 'items' => ['item1', 'item2']]);
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], $body));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::PUT, ['Accept' => 'application/json'], ['name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::PATCH, ['Accept' => 'application/json'], ['name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $httpClient = new HttpClient();
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::DELETE, ['Accept' => 'application/json', 'Content-Type' => 'application/x-www-form-urlencoded'], ['name' => 'Mark', 'nick' => 'thefosk']));
        $this->assertEquals(200, $response->getStatusCode());
    ...
    public function testUploadWithoutHelper()
    {
        $httpClient = new HttpClient();
        $fixture = __DIR__ . '/Mocking/upload.txt';
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], ['name' => 'Mark', 'file' => Body::File($fixture)]));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
        $this->assertEquals('Mark', $response->getBody()->postData->params->name);
        $this->assertEquals('This is a test', $response->getBody()->postData->params->file);
    ...
    public function testUploadIfFilePartOfData()
    {
        $httpClient = new HttpClient();
        $fixture = __DIR__ . '/Mocking/upload.txt';
        $response = $httpClient->execute(new Request('http://mockbin.com/request', RequestMethod::POST, ['Accept' => 'application/json'], ['name' => 'Mark', 'files[owl.gif]' => Body::File($fixture)]));
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('POST', $response->getBody()->method);
        $this->assertEquals('Mark', $response->getBody()->postData->params->name);
