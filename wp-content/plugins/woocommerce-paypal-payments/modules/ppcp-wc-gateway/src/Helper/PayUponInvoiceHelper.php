...
class PayUponInvoiceHelper
{
    ...
    public function is_checkout_ready_for_pui(): bool
    {
        ...
        if (!$this->is_valid_product() || !$this->is_valid_currency() || !$this->checkout_helper->is_checkout_amount_allowed(5, 2500)) {
            return \false;
        }
        return \true;
    }
    ...
    public function is_pay_for_order_ready_for_pui(): bool
    {
        ...
        $required_fields = array('first_name', 'last_name', 'email', 'phone', 'address_1', 'city', 'postcode', 'country');
